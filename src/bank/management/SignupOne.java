...
public class SignupOne extends JFrame implements ActionListener {
    ...
    SignupOne() {
        ...
        JLabel fname = new JLabel("FATHER:");
        ...
        dobTextField = new JSpinner(dateModel);

        JSpinner.DateEditor dateEditor = new JSpinner.DateEditor(dobTextField, "dd/MM/yyyy");
        dobTextField.setEditor(dateEditor);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        String dob = ((JSpinner.DateEditor) dobTextField.getEditor())
                .getFormat().format(dobTextField.getValue());
